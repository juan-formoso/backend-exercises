...
// Losangle Exercise
console.log(
  `Losângulo de base 32cm e altura 18cm: ${Exercise.losangleArea(32, 18)}cm²`
);
console.log(
  `Losângulo de base 200cm e altura 50cm ${Exercise.losangleArea(200, 50)}cm²`
);
console.log(
  `Losângulo de base 75cm e altura 25cm ${Exercise.losangleArea(75, 25)}cm²`
);

// Trapeze Exercise
console.log(
  `Trapézio de base1 100cm, base2 70cm, altura 50cm: ${Exercise.trapezeArea(
    100,
    70,
    50
  )}cm²`
...
console.log(
  `Trapézio de base1 75cm, base2 50cm, altura 35cm ${Exercise.trapezeArea(
    75,
    50,
    35
  )}cm²`
...
console.log(
  `Trapézio de base1 150cm, base2 120cm, altura 80cm ${Exercise.trapezeArea(
    150,
    120,
    80
  )}cm²`
